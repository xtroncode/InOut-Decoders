...
export default class DiseaseCharts extends ParseComponent {
  ...
  render() {
    ...
    return (
      <div>
        <div className="Bar2Chart">
          <h3> Bar Chart </h3>
          <Chart chartType='BarChart' data={data} options={options} graph_id="barchart_graph3"/>
        </div>
        <div className="Yolo2Chart">
          <h3> Yolo Chart </h3>
          <Chart chartType='BarChart' data={data} options={options} graph_id="barchart_graph4"/>
        </div>
      </div>
